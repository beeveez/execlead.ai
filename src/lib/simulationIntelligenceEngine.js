...
export const SCENARIO_LIBRARY = [
  ...
  // Legal Leadership (Legal Leadership Track™ — leadership development only, never legal advice)
  { id: "legal_service_delivery_crisis", domain: "Legal Leadership", title: "Legal Service Delivery Crisis", difficulty: "expert", paths: ["Legal Leadership"], competencies: ["strategic_thinking", "decision_quality", "stakeholder_management", "organizational_leadership", "risk_leadership"], description: "Legal requests have increased significantly while the legal team has limited capacity. Determine intake strategy, prioritization, escalation, SLAs, stakeholder communication, resource allocation, and process improvement." },
  { id: "legal_enterprise_transformation", domain: "Legal Leadership", title: "Enterprise Legal Transformation", difficulty: "advanced", paths: ["Legal Leadership"], competencies: ["strategic_thinking", "change_leadership", "organizational_leadership", "stakeholder_management", "decision_quality"], description: "The organization wants to modernize its legal operating model. Evaluate current-state processes, technology opportunities, operating model, change management, governance, and measurement." },
  { id: "legal_technology_investment", domain: "Legal Leadership", title: "Legal Technology Investment", difficulty: "advanced", paths: ["Legal Leadership"], competencies: ["business_acumen", "decision_quality", "risk_leadership", "executive_communication", "strategic_thinking"], description: "The legal department requests a new legal technology platform. Prepare a business case, risk analysis, adoption strategy, ROI assumptions (clearly identified), governance model, and executive recommendation." },
  { id: "legal_contract_backlog", domain: "Legal Leadership", title: "Contract Operations Backlog", difficulty: "advanced", paths: ["Legal Leadership"], competencies: ["organizational_leadership", "decision_quality", "stakeholder_management", "executive_communication"], description: "Contract requests have accumulated across business units. Evaluate intake, prioritization, workflow, capacity, escalation, automation opportunities, and executive communication." },
  { id: "legal_outside_counsel_management", domain: "Legal Leadership", title: "Outside Counsel Management", difficulty: "intermediate", paths: ["Legal Leadership"], competencies: ["business_acumen", "stakeholder_management", "risk_leadership", "executive_communication"], description: "External legal spend is increasing. Evaluate vendor governance, matter visibility, spend controls, performance metrics, stakeholder management, and escalation." },
  { id: "legal_ai_governance", domain: "Legal Leadership", title: "Legal AI Governance", difficulty: "expert", paths: ["Legal Leadership"], competencies: ["risk_leadership", "decision_quality", "change_leadership", "stakeholder_management", "executive_communication"], description: "An enterprise wants to introduce generative AI into the legal function. Evaluate governance, human oversight, data protection, risk controls, accuracy verification, auditability, change management, and responsible AI." },
];
