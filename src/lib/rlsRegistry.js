...
export const RLS_REGISTRY = [
  ...
  // ── Phase 1 Reconciliation (registered 2026-09-14) ──
  // 3 Phase 1 entities with compliant live RLS policies, previously unregistered.
  { name: "Vendor", classification: "organization", scope: "organization_id", status: "protected", sensitive: true, rule: "same-org read + platform admin/founder CUD" },
  { name: "BetaFeedback", classification: "user", scope: "user_id", status: "protected", sensitive: true, rule: "owner + admin CUD" },
  { name: "ExecutiveOutcome", classification: "user", scope: "user_id", status: "protected", sensitive: true, rule: "owner + admin CUD" },

  // ── Organization-Scoped Phase 2 (registered 2026-09-14) ──
  { name: "StrategicPartner", classification: "organization", scope: "organizationId", status: "protected", sensitive: true, rule: "same-org + founder/super/platform admin/sales; org admin/owner scoped by orgId" },
  { name: "StrategicPartnerAuditLog", classification: "organization", scope: "organizationId", status: "protected", sensitive: false, rule: "immutable append-only; same-org + admin/dev read; no update/delete" },
  { name: "PartnerObjective", classification: "organization", scope: "organizationId", status: "protected", sensitive: false, rule: "same-org + founder/super/platform admin/sales" },
  { name: "PartnerOpportunity", classification: "organization", scope: "organizationId", status: "protected", sensitive: false, rule: "same-org + founder/super/platform admin/sales/finance" },
  { name: "PartnerInteraction", classification: "organization", scope: "organizationId", status: "protected", sensitive: false, rule: "same-org + founder/super/platform admin/sales" },
  { name: "PartnerInitiative", classification: "organization", scope: "organizationId", status: "protected", sensitive: false, rule: "same-org + founder/super/platform admin/sales" },
  { name: "EnterpriseTalentAnalytics", classification: "organization", scope: "organizationId", status: "protected", sensitive: true, rule: "same-org + enterprise_admin; super/platform admin" },
  { name: "SuccessionCandidateProfile", classification: "organization", scope: "organizationId", status: "protected", sensitive: true, rule: "same-org + enterprise_admin; super/platform admin" },
  { name: "TalentIntelligenceAuditEvent", classification: "organization", scope: "organizationId", status: "protected", sensitive: true, rule: "immutable append-only; same-org + enterprise_admin read; no update/delete" },
  { name: "GovernanceAuditLog", classification: "organization", scope: "organizationId", status: "protected", sensitive: false, rule: "immutable append-only; same-org + enterprise_admin read; super_admin/platform_admin update only" },

  // ── User-Scoped Phase 2 (registered 2026-09-14) ──
  { name: "Skill", classification: "user", scope: "created_by_id", status: "protected", sensitive: false, rule: "owner + admin; immutable update/delete restricted" },
  { name: "ExecutiveBriefing", classification: "user", scope: "created_by_id", status: "protected", sensitive: false, rule: "owner + admin" },
  { name: "ExecutiveAction", classification: "user", scope: "created_by_id", status: "protected", sensitive: false, rule: "owner + admin" },
  { name: "SocialContent", classification: "user", scope: "created_by_id", status: "protected", sensitive: false, rule: "owner + admin/content_manager/marketing_admin CUD" },
  { name: "GovernanceRequest", classification: "user", scope: "created_by_id", status: "protected", sensitive: false, rule: "owner + admin; immutable update/delete restricted" },
  { name: "ExecutiveIdentity", classification: "user", scope: "created_by_id", status: "protected", sensitive: true, rule: "owner + admin" },
  { name: "ExecutiveSuccessStory", classification: "user", scope: "created_by_id", status: "protected", sensitive: false, rule: "owner + admin" },
  { name: "DecisionProfile", classification: "user", scope: "created_by_id", status: "protected", sensitive: false, rule: "owner + admin" },
  { name: "DecisionAttempt", classification: "user", scope: "created_by_id", status: "protected", sensitive: false, rule: "owner + admin" },
  { name: "FounderStory", classification: "user", scope: "created_by_id", status: "protected", sensitive: false, rule: "owner + admin" },
  { name: "AnswerAttempt", classification: "user", scope: "created_by_id", status: "protected", sensitive: false, rule: "owner + admin" },
  { name: "PracticeSession", classification: "user", scope: "created_by_id", status: "protected", sensitive: false, rule: "owner + admin" },
  { name: "ExecVerification", classification: "user", scope: "created_by_id", status: "protected", sensitive: true, rule: "owner + admin" },
  { name: "ReadinessAssessment", classification: "user", scope: "created_by_id", status: "protected", sensitive: true, rule: "owner + admin" },
  { name: "PromotionForecast", classification: "user", scope: "created_by_id", status: "protected", sensitive: false, rule: "owner + admin" },
  { name: "ResumeImport", classification: "user", scope: "created_by_id", status: "protected", sensitive: true, rule: "owner + admin" },
  { name: "BehavioralEvidenceRecord", classification: "user", scope: "created_by_id", status: "protected", sensitive: false, rule: "owner + admin" },
  { name: "CompetencyProgressSignal", classification: "user", scope: "created_by_id", status: "protected", sensitive: false, rule: "owner + admin" },
  { name: "SuccessStoryEvidenceItem", classification: "user", scope: "created_by_id", status: "protected", sensitive: false, rule: "owner + admin" },

  // ── Platform-Scoped Phase 2 (registered 2026-09-14) ──
  { name: "KnowledgeArticle", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev/founder CUD; all authenticated read" },
  { name: "KnowledgeRegistryEntry", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev/founder CUD" },
  { name: "PlatformActivity", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "immutable append-only; admin/dev read; no update/delete" },
  { name: "GovernanceNotificationLog", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "immutable append-only; admin/dev read; no update/delete" },
  { name: "WorkflowExecutionLog", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "immutable append-only; admin/dev read; no update/delete" },
  { name: "NewsletterSubscription", classification: "platform", scope: "—", status: "protected", sensitive: true, rule: "admin/dev only" },
  { name: "PerformanceJob", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "ExecutiveInsight", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "CommercialTask", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "AutomationRule", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "GovernanceConfig", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "immutable; admin/dev read; no update/delete" },
  { name: "DecisionScenario", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "LaunchQuestion", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "InterviewScenario", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "RemediationPatch", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "BetaApplication", classification: "platform", scope: "—", status: "protected", sensitive: true, rule: "immutable; admin/dev read; no update/delete" },
  { name: "QualityControlMetric", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "RootCauseAnalysis", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "ImprovementProject", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "MarketForecast", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "MarketNews", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "MarketTrend", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "WinLossRecord", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "CompetitorProfile", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "CompetitiveEvidence", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "ArchitectureDecision", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "ArchitectureException", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "ArchitectureProposal", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "ExecutiveDecision", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "EnterpriseIntegration", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "BusinessIntelligenceReport", classification: "platform", scope: "—", status: "protected", sensitive: true, rule: "admin/dev only" },
  { name: "DeletionPolicyConfig", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "immutable; admin/dev read; no update/delete" },
  { name: "IdentitySyncStatus", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "OtpActivityLog", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "immutable append-only; admin/dev read; no update/delete" },
  { name: "ProductCapabilityMetric", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "ProductInsight", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "ReleaseBlocker", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "RoadmapProposal", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "ScheduledMaintenance", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "SystemIncident", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "FeatureFlag", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "ChangeHistory", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "immutable append-only; admin/dev read; no update/delete" },
  { name: "AIOptimizationEvent", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "immutable append-only; admin/dev read; no update/delete" },
  { name: "AIPolicyEvent", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "immutable append-only; admin/dev read; no update/delete" },
  { name: "AIRequestTrace", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "immutable append-only; admin/dev read; no update/delete" },
  { name: "ModelRoutingEvent", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "immutable append-only; admin/dev read; no update/delete" },
  { name: "EvidenceCollection", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "EvidenceRequest", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "BetaCohort", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "BetaCommunication", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "BetaInvitation", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "CalibrationReview", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "ContinuousImprovementAction", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "EnterpriseROICalculation", classification: "user", scope: "created_by_id", status: "protected", sensitive: false, rule: "owner + admin" },
  { name: "KnowledgeIntelligenceReport", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
  { name: "KnowledgeInteraction", classification: "platform", scope: "—", status: "protected", sensitive: false, rule: "admin/dev only" },
];
