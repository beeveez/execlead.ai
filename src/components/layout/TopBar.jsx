...
export default function TopBar() {
  ...
  return (
    <div className="hidden lg:flex items-center justify-end gap-3 px-8 py-2.5 border-b border-white/5">
      <WorkspaceSwitcher />
      <Link to="/concierge" className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-indigo-500/10 hover:bg-indigo-500/20 transition-colors text-xs text-indigo-400">
