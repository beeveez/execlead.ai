...
export function getLaunchCountdownPhase(timeLeft) {
  ...
  if (timeLeft.remaining <= 30 * DAY) return { label: `${Math.ceil(timeLeft.remaining / DAY)} DAYS UNTIL THE EXECUTIVE JOURNEY BEGINS`, message: 'A meaningful new chapter in your leadership journey is approaching.' };
