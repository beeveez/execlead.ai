      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          <div className="lg:col-span-2 space-y-4 text-white/60 text-sm md:text-base leading-relaxed">
            <p>
              <strong className="text-white/80"><span className="text-brand-wordmark">EXECLEAD.AI</span> started with a personal problem.</strong>
            </p>
            <p>
