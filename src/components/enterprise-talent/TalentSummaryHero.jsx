...
export default function TalentSummaryHero({ snapshot }) {
  const metrics = [
    ...
    [Network, "Succession Bench Strength", typeof snapshot.successionBenchStrength === "string" ? snapshot.successionBenchStrength : snapshot.successionBenchStrength >= 70 ? "Strong" : snapshot.successionBenchStrength >= 50 ? "Moderate" : "At Risk"],
  ];
