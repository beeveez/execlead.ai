...
export async function generateContractPDF(quote, breakdown, catalog) {
  ...
  pdf.title("MASTER SERVICE AGREEMENT", 16)
     ...
     .spacer(8)
     .heading("1. Parties")
     .paragraph(`This Master Service Agreement ("Agreement") is entered into by and between EXECLEAD.AI ("Provider") and ${quote.organization_name} ("Customer"), collectively the "Parties."`)
     .paragraph(`Provider: EXECLEAD.AI, a leadership development platform.`)
