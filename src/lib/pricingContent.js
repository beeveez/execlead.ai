export const PLAN_CONTENT = {
  free: {
    ...
    idealFor: "Professionals exploring executive leadership.",
    outcome: "Discover your current Executive Readiness™ and begin building your leadership foundation.",
    keyMessage: "Learn where you stand before investing in your growth.",
    audience: ["Early Career", "Exploring Leaders", "Curious Professionals"],
  ...
  professional: {
    headline: "Accelerate Your Leadership Growth",
    idealFor: "Professionals preparing for management, senior leadership, and executive opportunities.",
    outcome: "Develop measurable executive capability through AI coaching, simulations, and personalized learning.",
    upgradeTrigger: "Ready to move beyond learning into structured leadership development.",
    audience: ["Aspiring Managers", "Senior ICs", "Future Executives", "Career Switchers"],
  ...
  executive: {
    headline: "Become Executive Ready",
    idealFor: "Managers, Directors, Senior Managers, Future CIOs, CTOs, COOs, and Executives.",
    outcome: "Continuously measure, develop, and demonstrate Executive Readiness™ through evidence, identity, simulations, and coaching.",
    audience: ["Managers", "Directors", "Senior Managers", "Future CIOs/CTOs", "Future COOs", "Executives"],
  ...
  enterprise: {
    headline: "Develop Executive Leaders at Scale",
    idealFor: "Organizations building leadership pipelines, succession planning, and executive capability.",
    outcome: "Create measurable leadership intelligence across your organization.",
    audience: ["Organizations", "HR & L&D", "Succession Planning", "Leadership Pipelines"],
