...
const APP_ROUTES = [
  ...
  { path: "/enterprise/organizations", component: "OrganizationManagement", name: "Organization Management™" },
  { path: "/enterprise/admin", component: "EnterpriseAdmin", name: "Enterprise Administration™" },
  { path: "/enterprise/identity", component: "EnterpriseIdentity", name: "Enterprise Identity™" },
