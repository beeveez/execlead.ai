...
export const PREVIEWS = [
  { title: 'Leadership Path Selection', sentence: 'Choose your executive destination and personalize every module.', to: '/assessment', icon: Compass, variant: 'path', businessValue: 'Personalizes every module — assessment, coaching, simulations, and identity — to your target executive role.', related: ['Executive Readiness Assessment™', 'AI Executive Coach™'], relatedScene: 'journey', relatedLabel: 'Watch Path Selection Demo' },
  { title: 'Executive Readiness Assessment™', sentence: 'A 10-minute assessment that reveals your leadership gaps.', to: '/assessment', icon: Gauge, variant: 'assessment', businessValue: 'Reveals your leadership gaps and unlocks a personalized 90-day roadmap.', related: ['Executive Dashboard™', 'Promotion Forecast™'], relatedScene: 'assessment', relatedLabel: 'Watch Assessment Demo' },
  { title: 'Executive Dashboard™', sentence: 'Your living command center for executive growth.', to: '/dashboard', icon: LineChart, variant: 'dashboard', businessValue: 'Turns evidence into your next executive action — not just another chart.', related: ['Outcome Intelligence™', 'Executive Concierge™'], relatedScene: 'outcomes', relatedLabel: 'Watch Outcomes Demo' },
  { title: 'Executive Coach™', sentence: 'Practice executive thinking through adaptive dialogue.', to: '/coach', icon: Brain, variant: 'coach', businessValue: 'Rehearse executive thinking with an AI that challenges your assumptions.', related: ['Executive Simulations™', 'Executive Debate™'], relatedScene: 'exec', relatedLabel: 'Watch AI Coaching Demo' },
  { title: 'Executive Simulations™', sentence: 'Real executive decisions with measurable outcomes.', to: '/simulator', icon: Swords, variant: 'simulations', businessValue: 'Practice high-stakes decisions with measurable, evidence-based feedback.', related: ['Executive Decision Lab™', 'Evidence Vault™'], relatedScene: 'practice', relatedLabel: 'Watch Simulation Demo' },
  { title: 'Executive Decision Lab™', sentence: 'Pressure-test decisions with AI transparency and alternatives.', to: '/decision-lab', icon: Layers, variant: 'decision', businessValue: 'Surface alternatives, trade-offs, and AI confidence behind every recommendation.', related: ['AI Decision Transparency™', 'Executive Simulations™'], relatedScene: 'exec', relatedLabel: 'Watch Decision Demo' },
  { title: 'Executive Identity Graph™', sentence: 'One verified executive identity powering every professional experience.', to: '/executive-identity-graph', icon: Network, variant: 'identity', businessValue: 'One verified identity powers every professional experience and export.', related: ['Executive Portfolio™', 'Executive Brand™'], relatedScene: 'identity', relatedLabel: 'Watch Identity Demo' },
  { title: 'Executive Success Stories™', sentence: 'Transform achievements into executive narratives.', to: '/executive-success-stories', icon: BookOpen, variant: 'stories', businessValue: 'Turn verified achievements into executive narratives that travel with you.', related: ['Executive Story Intelligence™', 'Executive Identity Graph™'], relatedScene: 'evidence', relatedLabel: 'Watch Evidence Demo' },
  { title: 'Executive Outcome Intelligence™', sentence: 'Track real executive development over time.', to: '/outcome-intelligence', icon: TrendingUp, variant: 'outcome', businessValue: 'Track measurable leadership growth — readiness, competency, and evidence — over time.', related: ['Promotion Forecast™', 'Executive Journey™'], relatedScene: 'outcomes', relatedLabel: 'Watch Outcomes Demo' },
  { title: 'Executive Portfolio™', sentence: 'A shareable, evidence-backed executive portfolio.', to: '/executive-portfolio', icon: FolderOpen, variant: 'portfolio', businessValue: 'A shareable, evidence-backed portfolio that proves executive readiness.', related: ['Executive Identity Graph™', 'Executive Success Stories™'], relatedScene: 'identity', relatedLabel: 'Watch Identity Demo' },
];
