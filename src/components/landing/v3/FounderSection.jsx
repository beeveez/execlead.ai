      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-white/40 max-w-xl mx-auto text-sm">
            <strong className="text-white/70">Reynaldo D. Valdez is the Founder &amp; Chief Product Architect of EXECLEAD.AI.</strong>
          </p>
          ...
          <p className="mx-auto mt-5 max-w-2xl text-sm leading-relaxed text-white/50">Building EXECLEAD.AI from firsthand experience in enterprise IT operations, service delivery, governance, and leadership.</p>
        </div>
