...
export function getLaunchCountdownPhase(timeLeft) {
  ...
  if (timeLeft.remaining <= 30 * DAY) return { label: `${Math.ceil(timeLeft.remaining / DAY)} DAYS UNTIL THE EXECUTIVE JOURNEY BEGINS`, message: 'Your leadership journey begins with Executive Readiness™.' };
