...
export const COMPLIANCE_FRAMEWORKS = [
  {
    name: "ISO/IEC 27001",
    status: "in_progress",
    description: "Preparation for an Information Security Management System assessment. This status does not represent certification.",
    timeline: "Preparation in progress — no certification date is claimed",
  },
  {
    name: "SOC 2 Type II",
    status: "planned",
    description: "A future independent assessment of relevant controls over time. EXECLEAD.AI is not SOC 2 certified.",
    timeline: "Planned — no audit period or completion date is claimed",
  },
  {
    name: "GDPR",
    status: "in_progress",
    description: "Privacy controls are being mapped against GDPR requirements. This status does not represent external certification or a formal compliance determination.",
    timeline: "Control review in progress — formal assessment pending",
  },
  {
    name: "ISO/IEC 27701",
    status: "planned",
...
export const SECURITY_REPORTING = {
  ...
  process: [
    { step: 1, title: "Report", detail: "Use the public contact form with a detailed description, reproduction steps, and potential impact. A dedicated security mailbox is planned." },
    { step: 2, title: "Acknowledge", detail: "Receipt is confirmed after the report is reviewed and assigned for triage." },
    { step: 3, title: "Validate", detail: "The report is validated and assessed for severity and impact." },
    { step: 4, title: "Remediate", detail: "Validated issues are prioritized and addressed according to severity and available evidence." },
    { step: 5, title: "Disclose", detail: "Where appropriate, disclosure timing is coordinated after remediation." },
  ],
  guidelines: [
