...
export const WORKSPACE_NAV = {
  executive: [
    ...
    { label: "Leadership", items: [
      ...
      { path: "/decision-intelligence", label: "Decision Intelligence™", icon: GitCompare },
  ...
  developer: [
    ...
    { label: "Platform Operations", items: [
      ...
      { path: "/developer/performance", label: "Performance Dashboard™", icon: Gauge },
      ...
      { path: "/developer/agent-approvals", label: "Agent Approval Review", icon: ShieldCheck },
