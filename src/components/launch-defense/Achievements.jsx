...
/**
 * Achievements™ — badges earned through practice: Investor Ready™,
 * Enterprise Ready™, Media Ready™, Board Ready™, Conference Speaker™,
 * TED Ready™, Founder Ready™, Executive Communicator™, 100 Questions Mastered™.
 */
export default function Achievements({ ld }) {
