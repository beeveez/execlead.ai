...
export default function EvidenceEngine() {
  return <section id="evidence" className="border-t border-white/5 px-6 py-20 lg:px-8" aria-labelledby="evidence-title">
