      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1 flex-wrap">
            ...
            {reputation && reputation.score > 0 && <ReputationBadges score={reputation.score} tier={reputation.tier} badges={reputation.badges} compact context={{ trustScore: reputation.community_trust || comment.author_trust_score, leadershipLevel: comment.author_title, topCompetency: reputation.top_competency }} />}
